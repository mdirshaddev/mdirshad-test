...
import { BiCheck, BiLogoGmail } from 'react-icons/bi';
import { BsArrowUpRight, BsSun, BsTextWrap } from 'react-icons/bs';
...
export const Icons = {
  ...
  social: {
    github: (props: Icon) => (
      <SiGithub
        className='cursor-pointer text-2xl text-black dark:text-white hover:dark:text-white md:text-2xl'
        {...props}
      />
    ),
    twitter: (props: Icon) => (
  ...
  textWrap: (props: Icon) => <BsTextWrap {...props} />,
  check: (props: Icon) => <BiCheck {...props} />,
  history: (props: Icon) => <MdHistory {...props} />,
