...
import { CommandDialogMenu } from "./command-palette";
      ...
      <div className="mx-auto flex w-full max-w-[1400px] flex-col-reverse items-center justify-between gap-4 px-8 py-4 lg:flex-row">
        <div className="flex flex-row flex-wrap justify-center gap-4">
          <Link href="/" className="flex items-center space-x-2">
            ...
            <span className="block font-bold">mdirshad</span>
          </Link>
          ...
          <HoverCard>
            <HoverCardTrigger asChild>
              <a
                ...
                target="_blank"
                href={checklyConfig.checklyStatus}
                className="cursor-newtab flex h-10 items-center gap-2 rounded-md border border-[#ececec] px-3 py-2 hover:bg-primary/[0.6] dark:border-[#222]"
                rel="noopener"
              >
                <p>Checkly</p>
                <div>
            ...
            <HoverCardContent className="w-80 cursor-pointer ring-1 ring-primary">
              <checklyConfig.checklyTooltipMessage />
            </HoverCardContent>
          </HoverCard>
        </div>
      </div>
            ...
            <HoverCard>
              <HoverCardTrigger asChild>
                <a
                  ...
                  target="_blank"
                  className="cursor-newtab flex w-full items-center gap-2 rounded-md border border-[#ececec] px-3 py-2 hover:bg-primary/[0.6] dark:border-[#222]"
                >
                  <Icons.social.github />
                  Source Code
                </a>
